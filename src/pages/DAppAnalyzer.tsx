...
import { Activity, Target, ArrowLeft, Search, TrendingUp, AlertCircle, Radio } from "lucide-react";
...
import LiveAmbientMonitor from "@/components/LiveAmbientMonitor";
...
const DAppAnalyzer = () => {
  ...
  const [activeTab, setActiveTab] = useState<'analysis' | 'live'>('analysis');
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          {activeTab === 'analysis' ? (
            ...
            <LiveAmbientMonitor isDarkMode={true} />
          )}
        </div>
      </main>
    </div>
